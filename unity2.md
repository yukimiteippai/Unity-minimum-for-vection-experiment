...
## 2.1 Hierarchyウィンドウ・GameObjectメニューから作る方法
...
### 2.2.2. 空のGameObjectにスクリプトコンポーネントを追加する
...
ここでは配列やfor文の基礎は知っているという前提で進めます。
...
#### 2.2.8.2. cubesのZ値をばらつかせる（カメラのZ位置から0までの間でランダムに）  
...
#### 2.2.8.3. cubesがカメラより後ろに行ったら、位置をz=0に戻す
...
- [unity2:GameObjectの作成と移動](https://github.com/yukimiteippai/Unity-minimum-for-vection-experiment/blob/main/unity2.md)(here)
